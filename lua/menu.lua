...
function Menu:InitVars()
	...
	self.backgroundSwitchTime = 1000 -- Fade-out time in ms
	-- JC2MP Logo
	self.logoMargin = 50 -- Top margin of logo
	self.logoWidth = 450 -- Width of logo
	self.logoHeight = 90 -- Height of logo
	-- Sidebar Config
	self.sidebarPadding = 20 -- Padding of sidebar
	self.sidebarExtraSpacing = 30 -- Extra space to the right of menu
	-- Icons Config
	self.iconMargin = 12 -- Right margin of an icon
	...
	self.featuredCountFontSize = 19 -- Font size of featured server name
	...
	self.favoriteMargin = 3 -- Margin between server name and player count
	...
	-- Menu Config
	self.menuButtonFontSize = 30 -- Font size of a menu button
	self.menuMargin = 15 -- Bottom margin of menu
	self.menuButtonMargin = 8 -- Top margin of a menu button
	-- Server Info Config
	...
	-- Fonts
	self.fonts = {}
	--Roboto this is Rum Raisin Cyrillic
...
function Menu:RenderLogo()
	...
	self.logo:Draw()
	Render:SetFont(AssetLocation.Disk, self.fonts["Text"])
	Render:DrawText( Vector2( (15), (Render.Height - 25) ), "Christmas UI by Hallkezz", self.colors["Alpha"], 14 )
end
